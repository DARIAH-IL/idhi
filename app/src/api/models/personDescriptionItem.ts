 ...
 */
import type { PersonDescriptionItemLanguage } from './personDescriptionItemLanguage.ts'
 ...
 */
export type PersonDescriptionItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: PersonDescriptionItemLanguage
