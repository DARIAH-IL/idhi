 ...
 */
import type { LocationAddressItem } from './locationAddressItem.ts'
import type { LocationDescriptionItem } from './locationDescriptionItem.ts'
import type { LocationNameItem } from './locationNameItem.ts'
import type { LocationType } from './locationType.ts'
