 ...
 */
import type { CatalogDescriptionItemLanguage } from './catalogDescriptionItemLanguage.ts'
 ...
 */
export type CatalogDescriptionItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: CatalogDescriptionItemLanguage
