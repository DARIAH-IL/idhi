 ...
 */
import type { TrainingMaterialPrerequisitesItemLanguage } from './trainingMaterialPrerequisitesItemLanguage.ts'
 ...
 */
export type TrainingMaterialPrerequisitesItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: TrainingMaterialPrerequisitesItemLanguage
