 ...
 */
import type { OrganizationLocationItemLanguage } from './organizationLocationItemLanguage.ts'
 ...
 */
export type OrganizationLocationItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: OrganizationLocationItemLanguage
