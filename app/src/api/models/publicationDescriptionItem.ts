 ...
 */
import type { PublicationDescriptionItemLanguage } from './publicationDescriptionItemLanguage.ts'
 ...
 */
export type PublicationDescriptionItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: PublicationDescriptionItemLanguage
