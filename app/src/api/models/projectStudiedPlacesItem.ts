 ...
 */
import type { ProjectStudiedPlacesItemLanguage } from './projectStudiedPlacesItemLanguage.ts'
 ...
 */
export type ProjectStudiedPlacesItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: ProjectStudiedPlacesItemLanguage
