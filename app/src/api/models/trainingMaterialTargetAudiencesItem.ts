 ...
 */
import type { TrainingMaterialTargetAudiencesItemLanguage } from './trainingMaterialTargetAudiencesItemLanguage.ts'
 ...
 */
export type TrainingMaterialTargetAudiencesItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: TrainingMaterialTargetAudiencesItemLanguage
