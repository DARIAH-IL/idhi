 ...
 */
import type { OrganizationAddressItemLanguage } from './organizationAddressItemLanguage.ts'
 ...
 */
export type OrganizationAddressItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: OrganizationAddressItemLanguage
