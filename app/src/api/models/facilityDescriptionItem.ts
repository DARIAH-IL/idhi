 ...
 */
import type { FacilityDescriptionItemLanguage } from './facilityDescriptionItemLanguage.ts'
 ...
 */
export type FacilityDescriptionItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: FacilityDescriptionItemLanguage
