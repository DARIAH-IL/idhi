 ...
 */
import type { TrainingMaterialEducationalLevelItemLanguage } from './trainingMaterialEducationalLevelItemLanguage.ts'
 ...
 */
export type TrainingMaterialEducationalLevelItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: TrainingMaterialEducationalLevelItemLanguage
