 ...
 */
import type { LocationDescriptionItemLanguage } from './locationDescriptionItemLanguage.ts'
 ...
 */
export type LocationDescriptionItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: LocationDescriptionItemLanguage
