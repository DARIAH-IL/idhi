 ...
 */
import type { TimePeriodDescriptionItemLanguage } from './timePeriodDescriptionItemLanguage.ts'
 ...
 */
export type TimePeriodDescriptionItem = {
  /** Languages supported for free-text fields (BCP-47 tags). */
  language: TimePeriodDescriptionItemLanguage
