  ...
  'group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-oklch(0.922 0 0) border-transparent px-2 py-0.5 text-[0.625rem] font-medium whitespace-nowrap transition-all focus-visible:border-oklch(0.708 0 0) focus-visible:ring-[3px] focus-visible:ring-oklch(0.708 0 0)/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-oklch(0.577 0.245 27.325) aria-invalid:ring-oklch(0.577 0.245 27.325)/20 dark:aria-invalid:ring-oklch(0.577 0.245 27.325)/40 [&>svg]:pointer-events-none [&>svg]:size-2.5! dark:border-oklch(1 0 0 / 10%) dark:focus-visible:border-oklch(0.556 0 0) dark:focus-visible:ring-oklch(0.556 0 0)/50 dark:aria-invalid:border-oklch(0.704 0.191 22.216) dark:aria-invalid:ring-oklch(0.704 0.191 22.216)/20 dark:dark:aria-invalid:ring-oklch(0.704 0.191 22.216)/40',
  {
    variants: {
      variant: {
        ...
        outline:
          'border-oklch(0.922 0 0) bg-oklch(0.922 0 0)/20 text-oklch(0.145 0 0) dark:bg-oklch(0.922 0 0)/30 [a]:hover:bg-oklch(0.97 0 0) [a]:hover:text-oklch(0.556 0 0) dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(1 0 0 / 15%)/20 dark:text-oklch(0.985 0 0) dark:dark:bg-oklch(1 0 0 / 15%)/30 dark:[a]:hover:bg-oklch(0.269 0 0) dark:[a]:hover:text-oklch(0.708 0 0)',
        ghost:
